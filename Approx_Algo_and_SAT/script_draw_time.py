...
folder_path = "result"
file_names = [f"result_{i}.txt" for i in range(2, 15, 2)]

# Convert to microseconds by multiplying by 1 million
conversion_factor = 1e6
average_times = {"CNF-SAT-VC:": [], "APPROX-VC-1:": [], "APPROX-VC-2:": []}
std_dev_times = {
    "CNF-SAT-VC:": [],
    "APPROX-VC-1:": [],
    "APPROX-VC-2:": [],
...
for file_name in file_names:
    ...
    times = {"CNF-SAT-VC:": [], "APPROX-VC-1:": [], "APPROX-VC-2:": []}
...
plt.title(
    "Average Time of Algorithms for Each Result_i.txt in Microseconds with Standard Deviation"
)
plt.legend()
plt.savefig("average_times_microseconds_std.png")
print(
    "The plot with standard deviations has been saved as 'average_times_microseconds_std.png'."
)
